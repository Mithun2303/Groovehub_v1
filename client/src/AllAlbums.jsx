...
export const AllAlbums = ({ albums, setShowPopUp, setCurrentAlbum }) => {
  return (
      ...
      <div className="flex flex-col overflow-x-auto scrollbar mt-[10vh] gap-2">
        ...
        <ul className="text-text flex  flex-wrap   gap-4  ">
          {albums.map((album, index) => (
            <li
              className="w-[15vw] h-[35vh] flex justify-center items-center bg-[rgb(255,255,255,0.2)] rounded-2xl"
              key={index}
              onClick={(e) => {
